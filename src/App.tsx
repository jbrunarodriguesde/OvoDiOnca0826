...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#fdfbf7] text-[#1c2826] font-sans relative overflow-x-hidden selection:bg-[#e67e22] selection:text-[#1c2826]">
      {/* Tactile Noise Texture Overlay */}
      <div className="fixed inset-0 pointer-events-none noise-bg opacity-[0.025] z-50" />
      ...
      <motion.a
        ...
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-6 right-6 z-40 bg-[#25d366] hover:bg-[#20ba59] text-white p-3.5 rounded-full shadow-[0_4px_25px_rgba(37,211,102,0.4)] transition-colors flex items-center gap-2 group cursor-pointer"
      ...
      <AnimatePresence>
        {toastNotification && (
          <motion.div
            ...
            exit={{ opacity: 0, y: 30 }}
            transition={{ duration: 0.3 }}
            className="fixed bottom-6 left-6 z-50 bg-[#e67e22] text-[#1c2826] px-5 py-3.5 rounded-2xl shadow-2xl font-semibold text-xs sm:text-sm flex items-center gap-2.5"
          >
